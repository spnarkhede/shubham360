...
| Chapter | Title | Stage |
|---------|-------|-------|
| [Chapter 01](./chapter-01-foundations.md) | The Foundation — HTML, CSS, JavaScript | Stage 1 |
| [Chapter 02](./chapter-02-intermediate-frontend.md) | Intermediate Frontend Developer | Stage 2 |
| [Chapter 03](./chapter-03-react-in-depth.md) | React In Depth — Patterns, Hooks, and the Compiler | Stage 2–3 |
| [Chapter 04](./chapter-04-state-and-apis.md) | State Management and API Design | Stage 2–3 |
| [Chapter 05](./chapter-05-performance-security.md) | Performance, Security, and Accessibility | Stage 3 |
| [Chapter 06](./chapter-06-testing-devops.md) | Testing, CI/CD, and DevOps | Stage 3 |
| [Chapter 07](./chapter-07-architecture-patterns.md) | Frontend Architecture Patterns | Stage 4 |
| [Chapter 08](./chapter-08-microfrontends-monorepos.md) | Micro-Frontends, Monorepos, and Multi-Team Scaling | Stage 4 |
| [Chapter 09](./chapter-09-architect-role.md) | The Frontend Architect Role — ADRs, Design Systems, Tech Radar | Stage 5 |
| [Chapter 10](./chapter-10-soft-skills-leadership.md) | Soft Skills and Technical Leadership | Stage 5 |
| [Chapter 11](./chapter-11-interview-prep.md) | Interview Preparation — All 25 Questions + System Design | All Stages |
