...
categories:
  - Technology
intro: |
  **Job Search Prompts Master Template** provides a comprehensive collection of AI-powered prompts designed to optimize your job search process.  
  These prompts cover everything from position finding and skill gap analysis to resume optimization and interview preparation.  
  Leverage the power of **Large Language Models (LLMs)** to enhance your job search strategy, improve your application materials, and increase your chances of landing your dream job.
plugins:
  - copyCode
  - runCode
---
