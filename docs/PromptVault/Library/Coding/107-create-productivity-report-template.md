---
id: 107-create-productivity-report-template
---
...
| **Date** | 2026-05-28 |
| **Views** | 13 |
| **Tags** | Coding, Productivity, Time Management, Report, Template |
| **Recommended Tools** | ChatGPT, Claude, Grok |

> Optimize your productivity analysis with this ChatGPT mega-prompt, creating an intuitive weekly time report template for insightful data tracking.
...
- Encourage users to provide qualitative feedback in the Weekly Summary on what worked well and what didn\
