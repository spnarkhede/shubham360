---
id: 115-design-administrative-dashboard
---

## 🖥️ Design Administrative Dashboard
...
| **Date** | 2026-05-28 |
| **Views** | 69 |
| **Tags** | Performance, Design, Coding, AI Prompts, Administrative |
| **Recommended Tools** | ChatGPT, Gemini, Claude |

> Design an intuitive admin dashboard with this AI prompt, following Apple\
...
- Assists in creating an intuitive admin dashboard following Apple\
- ,
- ,
