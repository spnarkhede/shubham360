---
id: 94-create-component-inventories
---
...
> Create a comprehensive component inventory with this AI prompt, transforming scattered UI elements into a scalable design system.
...
- Adapts approach based on app\
- s design maturity.

### Tips

- Start by assessing your app\
- ,
- ,
...
2. Example: "My app has 25 screens, no existing style guide, and the biggest pain point is inconsistency in button styles."
