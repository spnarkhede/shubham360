...
> Create consistent documentation standards with this AI prompt, covering voice, structure, formatting, accessibility, and review protocols for knowledge bases.
...
1. Provide brand voice, customer profile, and KB platform context.
2. Run prompt, align internally, then enforce via review protocol.
