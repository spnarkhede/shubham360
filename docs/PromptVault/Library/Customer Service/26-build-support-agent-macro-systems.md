...
> Build scalable support macro systems with this AI prompt, including scenario taxonomy, reusable response blocks, personalization fields, and quality controls.

### Prompt

```
Create a support macro architecture with:
- Scenario taxonomy
...
1. Provide ticket taxonomy and platform constraints.
2. Run prompt and implement macro governance workflow.
