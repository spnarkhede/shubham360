...
> Craft SLA breach response templates with this AI prompt, including accountability messaging, recovery plans, customer reassurance, and preventive follow-up communication.

### Prompt

```
Create SLA breach response templates by scenario:
...
1. Provide SLA and compensation boundaries.
2. Run prompt and add templates to incident communication SOPs.
