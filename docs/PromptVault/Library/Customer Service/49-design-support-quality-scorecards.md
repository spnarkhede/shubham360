...
| **Date** | 2026-05-28 |
| **Views** | 35 |
| **Tags** | Support, Customer Experience, Live Chat, Business Strategy |
| **Recommended Tools** | ChatGPT, Gemini, Claude |

> Create support quality scorecards with this AI prompt, including scoring categories, evaluation scales, red flags, coaching templates, and performance improvement frameworks.
...
- Review a sample of past support conversations before using this AI prompt to identify patterns in agent performance, which helps you provide accurate context about your team\
- ,
- ,
