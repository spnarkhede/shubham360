---
id: 01-analyze-customer-churn-risks
---

## ðŸ›Ÿ Analyze Customer Churn Risks
...
Each email must feel like it comes from a human who genuinely cares about their success, not a marketing automation sequence. Tone should be warm, professional, and consultativeâ€”never desperate or salesy.
...
2. Identify triggers that are specific and actionableâ€”avoid vague indicators like "low engagement"
...
7. Avoid technical jargonâ€”make insights accessible to non-analyst stakeholders
...
2. Each email must provide standalone valueâ€”assume they only read one
3. Avoid corporate speak and feature-dumpingâ€”focus on outcomes and problem-solving
...
- **Risk Level**: Low/Medium/High with visual indicator (ðŸŸ¢/ðŸŸ¡/ðŸ”´)
