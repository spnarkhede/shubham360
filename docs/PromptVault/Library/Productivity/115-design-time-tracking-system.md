---
id: 115-design-time-tracking-system
---

## ⏱️ Design Time Tracking System
...
| **Date** | 2026-05-28 |
| **Views** | 17 |
| **Tags** | Performance, Design, Architecture, Productivity, Workflow |
| **Recommended Tools** | ChatGPT, Claude, Gemini, Grok |

> Design an efficient time tracking system with this ChatGPT mega-prompt, addressing user personas, data models, reporting needs, and technical architecture.
