---
id: 235-improve-weekly-performance
---

## ⚗️ Improve Weekly Performance
...
| **Date** | 2026-05-28 |
| **Views** | 110 |
| **Tags** | Opportunity Analysis, Prioritization, Weekly Planning, Productivity |
| **Recommended Tools** | ChatGPT, Gemini, Claude |

> Reflect on your week and identify improvements with this AI prompt, analyzing successes, challenges, patterns, and actionable goals for growth.
...
- Analyzes your weekly experiences to find patterns in what worked and what didn\
- ,
- ,

### Tips

- Schedule a consistent time each week to use this AI prompt for reflection, making it a non-negotiable habit that ensures you capture insights while they\
- ,
- ,
- s analysis, ask follow-up questions about implementing the suggested improvements in your specific business context to create a clear action plan for the upcoming week.

### How to use

1. Fill in what went well during your week, what didn\
2. ,
3. t go well: I struggled with time management during meetings. What I learned: Morning hours are my most productive time for deep work."
