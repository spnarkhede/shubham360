---
id: 94-create-smart-objectives-template
---

## 🎯 Create SMART Objectives Template
...
| **Date** | 2026-05-28 |
| **Views** | 18 |
| **Tags** | Performance, Productivity, Workflow, SMART, Objectives |
| **Recommended Tools** | ChatGPT, Claude, Grok |

> Create effective SMART objectives and OKRs with this ChatGPT mega-prompt, guiding you through specific, measurable, achievable, relevant, and time-bound goal-setting.
