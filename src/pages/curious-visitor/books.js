...
const books = [
  ...
  },
  {
    ...
    cover: '/img/books/dontBelieveEverythingYouThink.webp',
    rating: 4,
    readDate: 'TBD',
    summary: 'How to recognize and overcome the cognitive biases that distort our thinking.',
    categories: ['Psychology', 'Self-Improvement'],
    reviewLink: '/books/dont-believe-everything-you-think',
  },
  {
    title: 'Your Next Five Moves',
    author: 'Patrick Bet-David',
    cover: '/img/books/yourNextFiveMoves.webp',
    rating: 4,
    readDate: 'TBD',
    summary: 'A strategic approach to planning your career and business moves.',
    categories: ['Business', 'Strategy'],
    reviewLink: '/books/your-next-five-moves',
  },
  {
    title: 'The Compound Effect',
    author: 'Darren Hardy',
    cover: '/img/books/theCompoundEffect.webp',
    rating: 4,
    readDate: 'TBD',
    summary: 'How small daily choices lead to extraordinary results over time.',
    categories: ['Self-Improvement', 'Productivity'],
    reviewLink: '/books/the-compound-effect',
  },
  {
    title: 'The 7 Habits of Highly Effective People',
    author: 'Stephen R. Covey',
    cover: '/img/books/the7HabitsOfHighlyEffectivePeople.webp',
    rating: 5,
    readDate: 'TBD',
    summary: 'Powerful lessons in personal change and effectiveness.',
    categories: ['Self-Improvement', 'Leadership'],
    reviewLink: '/books/the-7-habits-of-highly-effective-people',
  },
  {
    title: 'Ego is the Enemy',
    author: 'Ryan Holiday',
    cover: '/img/books/egoIsTheEnemy.webp',
    rating: 4,
    readDate: 'TBD',
    summary: 'How to master your ego and find long-term success.',
    categories: ['Self-Improvement', 'Philosophy'],
    reviewLink: '/books/ego-is-the-enemy',
  },
  {
    title: 'Eat That Frog',
    author: 'Brian Tracy',
    cover: '/img/books/eatThatFrog.webp',
    rating: 4,
    readDate: 'TBD',
    summary: '21 great ways to stop procrastinating and get more done in less time.',
    categories: ['Productivity', 'Self-Improvement'],
    reviewLink: '/books/eat-that-frog',
  },
  {
    title: 'The Power of Now',
    author: 'Eckhart Tolle',
    cover: '/img/books/thePowerOfNow.webp',
    rating: 5,
    readDate: 'TBD',
    summary: 'A guide to spiritual enlightenment and living in the present moment.',
    categories: ['Philosophy', 'Spirituality'],
    reviewLink: '/books/the-power-of-now',
  },
  {
    title: 'Why Men Love Bitches',
    author: 'Sherry Argov',
    cover: '/img/books/whyMenLoveBitches.webp',
    rating: 3,
    readDate: 'TBD',
    summary: 'From Doormat to Dreamgirl - A Woman\'s Guide to Holding Her Own in Relationships.',
    categories: ['Relationships', 'Self-Improvement'],
    reviewLink: '/books/why-men-love-bitches',
  },
  {
    title: 'Self Heal by Design',
    author: 'Barbara O\'Neill',
    cover: '/img/books/selfHealByDesign.webp',
    rating: 4,
    readDate: 'TBD',
    summary: 'Natural healing approaches for optimal health and wellbeing.',
    categories: ['Health', 'Wellness'],
    reviewLink: '/books/self-heal-by-design',
  },
  {
    title: 'Sustain Me',
    author: 'Barbara O\'Neill',
    cover: '/img/books/sustainMe.webp',
    rating: 4,
    readDate: 'TBD',
    summary: 'Herbal medicine and nutritional approaches to sustained energy and vitality.',
    categories: ['Health', 'Wellness'],
    reviewLink: '/books/sustain-me',
  },
];
          ...
          <div className={styles.bookCoverContainer}>
            <img 
              ...
              onError={(e) => {
                ...
                e.target.src = "/img/books/default-book-cover.webp";
              }}
            />
          </div>
