const analyzeLoopBehaviorPrompt = {
  emoji: '🔄',
  title: 'Analyze Loop Behavior',
  description: 'Understand loop behavior with this AI prompt, focusing on iteration mechanics, termination conditions, and computational complexity.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- **Common Pitfalls** (specific to this loop type)`,
  ...
  tips: [
    ...
    'Focus on identifying what changes versus what remains constant in each iteration to understand the loop\'s mathematical sequence.',
  ],
  howToUse: [
    'Fill in the [INSERT LOOP CODE], [SPECIFY LANGUAGE], and [DESCRIBE WHAT\'S UNCLEAR] placeholders inside #INFORMATION ABOUT ME section with your specific loop code, programming language, and confusion point.',
    'Example: "My loop code is a for-loop iterating over an array. I\'m using Python, and I\'m unclear about why the loop doesn\'t terminate as expected."',
  ],
};

export default analyzeLoopBehaviorPrompt;
