const buildAPIPollingSystemPrompt = {
  emoji: '🌱',
  title: 'Build API Polling System',
  description: 'Build resilient API polling systems with this AI prompt, respecting API limits and adapting to service availability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Ready to begin building your API polling system? Please provide the requested information to start Phase 1.`,
  ...
  tips: [
    'Understand the natural rhythms of your API to set intelligent polling intervals, ensuring you don\'t overwhelm the system while keeping data fresh.',
    'Use adaptive strategies to handle rate limits and authentication, allowing your system to respond dynamically to changes in API availability.',
    'Continuously monitor API responses for patterns that indicate service health, adjusting your approach to maintain a reliable connection.',
  ],
  howToUse: [
    'Run the full prompt and answer the questions as detailed as possible.',
    'Example: "List of API endpoints: https://api.example.com/data, Authentication method: OAuth, Desired polling frequency: every 5 minutes, Known rate limits: 100 requests per hour."',
  ],
};

export default buildAPIPollingSystemPrompt;
