const buildInventoryManagementAppsPrompt = {
  emoji: '⚙️',
  title: 'Build Inventory Management Apps',
  description: 'Architect an enterprise-grade inventory system with this AI prompt, transforming warehouse chaos into precision with React/TypeScript.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'Claude',
  output: 'Code',
...
Take a deep breath and work on this problem step-by-step. Create a single React component file that's fully functional out of the box with all necessary imports, mock data, TypeScript types, and modern React patterns. Present your output as complete, executable code with inline comments explaining complex business logic.
  ...
  tips: [
    ...
    'Continuously gather feedback from warehouse staff on the system\'s usability and performance, using this data to refine and enhance the application.',
  ],
  howToUse: [
    'Fill in the [INSERT YOUR PREFERRED REACT/TYPESCRIPT STACK AND LIBRARIES], [INSERT YOUR SPECIFIC WAREHOUSE/INVENTORY OPERATION TYPE], [INSERT YOUR SPECIFIC INVENTORY PAIN POINTS], [INSERT YOUR BUSINESS SIZE AND TRANSACTION VOLUME], and [INSERT YOUR PREFERRED UI/UX DESIGN APPROACH] placeholders with your specific technical preferences, warehouse type, challenges, business scale, and design approach.',
    'Example: "My preferred stack includes React with Redux for state management and Material-UI for design. My warehouse operation type is a large-scale distribution center. My current inventory challenges include frequent stock-outs and overstock issues. My business processes over 10,000 transactions per second. I prefer a clean, minimalist UI/UX design approach."',
  ],
};

export default buildInventoryManagementAppsPrompt;
