const buildLogParserPrompt = {
  emoji: '🧩',
  title: 'Build Log Parser',
  description: 'Create a comprehensive log parser with this AI prompt, transforming unstructured log data into actionable insights through systematic pattern recognition.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your response with clear sections including Pattern Analysis, Parsing Rules, Sample Output, and Summary Statistics. Provide the actual parser logic in code blocks and include sample parsed output in your specified format.`,
  ...
  howToUse: [
    'Fill in the [PASTE YOUR RAW LOG ENTRIES HERE], [INSERT WHETHER YOU NEED SECURITY MONITORING, PERFORMANCE ANALYSIS, ERROR TRACKING, ETC.], [INSERT JSON OR CSV], [INSERT SPECIFIC DATA POINTS YOU WANT TO EXTRACT], and [INSERT ANY SPECIFIC SEVERITY LEVELS, TIME RANGES, OR CONDITIONS] placeholders with your log samples, primary use case, preferred output format, specific fields of interest, and filtering requirements.',
    'Example: "My log samples: [2023-10-01 12:00:00 INFO User login successful from IP 192.168.1.1]. My primary use case: Security Monitoring. My preferred output format: JSON. My specific fields of interest: timestamps, IP addresses, user identifiers. My filtering requirements: ERROR, CRITICAL severity levels."',
  ],
};

export default buildLogParserPrompt;
