const buildMultipartUploadSystemPrompt = {
  emoji: '🛡️',
  title: 'Build Multipart Upload System',
  description: 'Guide the implementation of a robust multipart upload system with this AI prompt, ensuring RFC 7578 compliance and handling real-world edge cases.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Your multipart upload system is now battle-tested and ready for production.`,
  ...
  howToUse: [
    ...
    'Example: "Upload endpoint URL: https://api.example.com/upload, File types: images, videos, Max size: 50GB, Tech stack: Node.js, Progress tracking: Yes, Error recovery: Yes."',
  ],
};

export default buildMultipartUploadSystemPrompt;
