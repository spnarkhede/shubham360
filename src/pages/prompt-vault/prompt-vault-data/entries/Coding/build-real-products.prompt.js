const buildRealProductsPrompt = {
  emoji: '🏗️',
  title: 'Build Real Products',
  description: 'Build real products with this AI prompt, guiding you through discovery, planning, development, polish, and deployment with full transparency and control.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'Claude',
  output: 'Code',
...
<next_steps>Clear actions for both of us to move forward</next_steps>
  ...
  tips: [
    'Before starting with this AI prompt, write down your product idea in the simplest terms possible and share it with someone unfamiliar with your vision to test if they understand the core problem you\'re solving.',
    'Set aside dedicated time blocks to actively participate in each phase of the AI prompt process, as your input and decision-making are critical to building a product that truly matches your vision.',
    'After completing the build with this AI prompt, ask for a prioritized roadmap of potential version 2 features based on user feedback you collect from early testers or your own usage patterns.',
  ],
  howToUse: [
    'Fill in the [Describe your product idea - what it does, who it\'s for, what problem it solves. Explain it like you\'d tell a friend.] and [Just exploring / I want to use this myself / I want to share it with others / I want to launch it publicly] placeholders with your specific product concept and commitment level.',
    'Example: "My product idea is a simple habit tracker app that sends daily reminders via text message. It\'s for busy parents who forget to drink water throughout the day. It solves the problem of dehydration by making reminders personal and easy. I want to use this myself and share it with my mom group."',
  ],
};

export default buildRealProductsPrompt;
