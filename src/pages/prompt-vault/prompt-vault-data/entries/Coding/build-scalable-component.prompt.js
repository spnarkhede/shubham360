const buildScalableComponentPrompt = {
  emoji: '🧬',
  title: 'Build Scalable Component',
  description: 'Create a scalable design system with this AI prompt, ensuring consistent implementation, rapid deployment, and enterprise-level quality.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Provide the component library structure as a hierarchical outline with detailed specifications for each component. Use markdown formatting with clear headings, code blocks for examples, and tables for prop definitions. Include file structure trees and visual diagrams where helpful. Organize documentation by atomic level (atoms → molecules → organisms) with cross-references between related components.`,
  ...
  tips: [
    'Start by defining your brand identity and technical constraints to align the design system with your organization\'s goals.',
    'Use design tokens to maintain consistency across colors, typography, and spacing, ensuring a unified visual language.',
    'Regularly update and iterate on the component library based on feedback and evolving requirements to keep it dynamic and relevant.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [INSERT BRAND COLOR PALETTE], [INSERT FONT FAMILIES AND HIERARCHY], [INSERT TECH STACK - React, Vue, Angular, etc.], [INSERT SPECIFIC WCAG LEVEL OR COMPLIANCE NEEDS], [LIST PRIORITY COMPONENTS NEEDED], and [INSERT FIGMA, SKETCH, ADOBE XD, etc.] placeholders with your specific design and technical preferences.',
    'Example: "My brand colors are blue and green. I prefer using Roboto and Arial fonts. My tech stack includes React and Vue. I need to comply with WCAG 2.1 AA standards. My initial components include buttons and forms. I use Figma for design."',
  ],
};

export default buildScalableComponentPrompt;
