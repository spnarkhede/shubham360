const buildUIComponentLibrariesPrompt = {
  emoji: '🛠️',
  title: 'Build UI Component Libraries',
  description: 'Create a cohesive design system with this AI prompt, ensuring consistent UI components across multiple products and teams.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<implementation_guide>Step-by-step setup instructions and integration recommendations</implementation_guide>
  ...
  tips: [
    'Define your design style preference and primary use case to ensure the UI kit aligns with your brand\'s vision and functional needs.',
    'Prioritize responsive behavior and accessibility considerations to make sure the components work seamlessly across different devices and user scenarios.',
    'Regularly update and refine the UI kit based on developer feedback and real-world implementation challenges to maintain its relevance and effectiveness.',
  ],
  howToUse: [
    'Fill in the [CSS FRAMEWORK], [DESIGN STYLE PREFERENCE], [PRIMARY USE CASE], [BRAND COLORS], and [TARGET DEVICES] placeholders with your specific choices and requirements.',
    'Example: "CSS Framework: Tailwind, Design Style Preference: Modern, Primary Use Case: Web App, Brand Colors: Primary - Blue, Secondary - Gray, Accent - Yellow, Target Devices: Desktop and Mobile prioritized."',
  ],
};

export default buildUIComponentLibrariesPrompt;
