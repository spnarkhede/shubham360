const clarifyErrorMessagesPrompt = {
  emoji: '🧩',
  title: 'Clarify Error Messages',
  description: 'Transform error messages with this AI prompt, offering clear, actionable guidance for developers to understand and fix issues.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
* IF complex system error:
  ...
  * Break into smaller sub-problems`,
  ...
  howToUse: [
    ...
    'Example: "The error message is \'Null Pointer Exception\'. The code snippet is \'int x = null;\'. I was trying to initialize a variable when this error appeared."',
  ],
};

export default clarifyErrorMessagesPrompt;
