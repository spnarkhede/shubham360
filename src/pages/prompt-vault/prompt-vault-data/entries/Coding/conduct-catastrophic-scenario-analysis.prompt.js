const conductCatastrophicScenarioAnalysisPrompt = {
  emoji: '🔮',
  title: 'Conduct Catastrophic Scenario Analysis',
  description: 'Uncover devastating worst-case scenarios with this ChatGPT mega-prompt, detailing catastrophic outcomes, stakeholder impacts, and critical lessons learned.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Lessons Learned: [takeaways on how this nightmare scenario could have been prevented]`,
  ...
  howToUse: [
    'Fill in the [BRIEFLY DESCRIBE THE SITUATION OR SYSTEM YOU WANT THE NIGHTMARE SCENARIO ANALYSIS FOR] placeholder with a concise description of the specific situation or system you are concerned about.',
    '- Example: If you are analyzing the potential catastrophic failures of a nuclear power plant, you might fill this in as "a coastal nuclear power plant susceptible to natural disasters."',
    'Example: To use this prompt effectively, if your concern is about cybersecurity in financial systems, you would fill in the placeholder as "the cybersecurity infrastructure of a major banking system."',
  ],
};

export default conductCatastrophicScenarioAnalysisPrompt;
