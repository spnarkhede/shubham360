const craftBugReportsPrompt = {
  emoji: '💡',
  title: 'Craft Bug Reports',
  description: 'Craft precise bug reports with this AI prompt, ensuring developers can reproduce issues effortlessly.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Structure the bug report using markdown with clear headers for each section. Use numbered lists for steps to reproduce, bullet points for environment details, and comparison tables for actual vs expected behavior. Include placeholders for screenshots/evidence marked with [ATTACH: description]. Format severity with bold text and use code blocks for any error messages or technical details.`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE WHAT HAPPENED], [WHAT WERE YOU DOING], [WHAT SHOULD HAVE HAPPENED], [SYSTEM/BROWSER/APP DETAILS], and [HOW THIS AFFECTS YOUR WORK] placeholders with specific information about your issue, actions, expectations, environment, and impact.',
    'Example: "I was editing a document in the latest version of Chrome on Windows 10 when the application crashed. I expected to save my changes, but instead, I lost all progress. This affects my ability to meet project deadlines."',
  ],
};

export default craftBugReportsPrompt;
