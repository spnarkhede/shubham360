const createContactFormPrompt = {
  emoji: '🛠️',
  title: 'Create Contact Form',
  description: 'Create a comprehensive contact form with this AI prompt, maximizing completion rates and ensuring security and proper data handling.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Optimization Recommendations (A/B testing suggestions for continuous improvement)`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [SPECIFY REQUIRED FIELDS AND OPTIONAL FIELDS], [EMAIL ADDRESS, DATABASE TYPE, OR CRM SYSTEM], [DAILY/WEEKLY SUBMISSION ESTIMATES], [LOW/MEDIUM/HIGH BASED ON INDUSTRY], and [HOW SUBMISSIONS WILL BE HANDLED] placeholders with your specific form requirements and business processes.',
    'Example: "Required fields: Name, Email, Message. Optional fields: Phone Number. Submission destination: CRM system. Expected form volume: 50 submissions weekly. Spam concerns: Medium. Follow-up process: Automated email response followed by manual review."',
  ],
};

export default createContactFormPrompt;
