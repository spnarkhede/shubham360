const createFunctionTemplatesPrompt = {
  emoji: '🛠️',
  title: 'Create Function Templates',
  description: 'Create function templates with this AI prompt, enforcing the Single Responsibility Principle through clear structure and documentation.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Follow the language's standard conventions for formatting and documentation. The template should be immediately usable as a starting point that enforces good practices through its structure.`,
  ...
  tips: [
    ...
    'Implement guard clauses and error handling to maintain simplicity and focus on the function\'s core purpose.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE THE ONE THING THIS FUNCTION SHOULD DO], [SPECIFY PROGRAMMING LANGUAGE], [LIST ESSENTIAL INPUTS ONLY], [DESCRIBE THE SINGLE OUTPUT], and [ANY LANGUAGE-SPECIFIC OR PROJECT CONSTRAINTS] placeholders with specific information about your function\'s purpose, language, inputs, output, and constraints.',
    'Example: "My function purpose is to calculate the sum of two numbers. My programming language is Python. My required inputs are two integers. My expected output is a single integer representing the sum. My specific constraints include handling only integer inputs."',
  ],
};

export default createFunctionTemplatesPrompt;
