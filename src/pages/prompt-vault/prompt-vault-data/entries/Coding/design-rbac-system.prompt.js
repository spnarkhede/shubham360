const designRBACSystemPrompt = {
  emoji: '🔒',
  title: 'Design RBAC System',
  description: 'Design and implement a robust RBAC system with this AI prompt, ensuring secure, scalable access control for your application.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<deployment_checklist>Security checklist and deployment considerations</deployment_checklist>
  ...
  tips: [
    'Clearly define user roles and permissions to align with your application\'s security needs, ensuring they are neither too restrictive nor too permissive.',
    'Regularly review and update your RBAC system to adapt to changes in user roles and application growth, maintaining security integrity.',
    'Implement thorough testing and monitoring to quickly identify and address any security gaps or unauthorized access attempts.',
  ],
  howToUse: [
    'Fill in the [SPECIFY THE TYPE OF APPLICATION], [LIST THE MAIN TECHNOLOGIES], and [SPECIFY DATABASE] placeholders with your application type, technology stack, and database system.',
    'Example: If your application type is a "web app," your technology stack includes "React and Node.js," and your database system is "PostgreSQL," your RBAC system should be designed to integrate seamlessly with these components.',
  ],
};

export default designRBACSystemPrompt;
