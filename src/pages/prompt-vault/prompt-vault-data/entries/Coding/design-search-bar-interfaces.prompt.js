const designSearchBarInterfacesPrompt = {
  emoji: '🔍',
  title: 'Design Search Bar Interfaces',
  description: 'Design an intuitive search bar with this AI prompt, following Baymard Institute\'s UX principles for seamless user experience.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Optional enhancement recommendations`,
  whatItDoes: [
    'Provides a structured approach to implementing a user-friendly search bar based on Baymard Institute\'s UX principles.',
    'Guides in designing a search interface that balances sophisticated functionality with intuitive simplicity.',
    'Ensures the search bar adapts to various content types and user behaviors for improved user experience.',
  ],
  tips: [
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE WHAT CONTENT WILL BE SEARCHED], [YES/NO AND ANY SPECIFIC REQUIREMENTS] for autocomplete, [DESCRIBE YOUR USERS AND THEIR SEARCH BEHAVIORS], and [ANY PLATFORM OR TECHNICAL LIMITATIONS] placeholders with specific information about your content and user context.',
    'Example: "My content types include product listings and blog articles. Autocomplete preference is yes, with a focus on popular search terms. My users are tech-savvy individuals who often search for specific product features. We have no major technical constraints."',
  ],
};

export default designSearchBarInterfacesPrompt;
