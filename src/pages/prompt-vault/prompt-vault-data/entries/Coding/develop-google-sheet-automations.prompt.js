const developGoogleSheetAutomationsPrompt = {
  emoji: '🔗',
  title: 'Develop Google Sheet Automations',
  description: 'Create bulletproof Google Sheets automation with this AI prompt, ensuring data integrity and respecting API limitations.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Include inline comments explaining critical decisions and potential failure points. Format code blocks with appropriate syntax highlighting. Provide example usage and testing scenarios.`,
  whatItDoes: [
    'Bridges disparate data systems while respecting Google\'s API limitations and maintaining data integrity.',
    'Automates Google Sheets as a presentation layer, ensuring formulas aren\'t corrupted and data integrity is preserved.',
  ...
  tips: [
    ...
    'Design your data pipeline with clear staging areas and transformation logic, applying Kimball\'s principles to treat Sheets as a presentation layer.',
    'Implement monitoring and alerts to quickly identify and address failures, using email or webhooks for notifications within 5 minutes of an issue.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [My Google Sheet URL], [My authentication method], [My data source], [My update schedule], and [My notification endpoint] placeholders with your specific details.',
    'Example: "My Google Sheet URL is https://docs.google.com/spreadsheets/d/12345. My authentication method is a service account JSON path. My data source is a database connection string. My update schedule is a cron expression for every hour. My notification endpoint is a Slack channel."',
    'Run the full prompt and answer the questions as detailed as possible.',
    'Example: Provide example answers to questions inside "PHASE 1" of the prompt.',
  ],
};

export default developGoogleSheetAutomationsPrompt;
