const developOptimisticUIPatternsPrompt = {
  emoji: '⚡',
  title: 'Develop Optimistic UI Patterns',
  description: 'Design and implement a comprehensive optimistic UI system with this AI prompt, ensuring seamless user experience and data integrity.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<testing_strategy>Approaches for testing optimistic UI behavior and edge cases</testing_strategy>
  ...
  howToUse: [
    'Fill in the [APP TYPE], [CURRENT TECH STACK], [USER ACTIONS TO OPTIMIZE], [DATA COMPLEXITY], and [PERFORMANCE REQUIREMENTS] placeholders with specific information about your application and technical requirements.',
    'Example: "App Type: E-commerce platform. Current Tech Stack: React, Redux, Node.js. User Actions to Optimize: Adding items to cart, updating user profile. Data Complexity: High, with multiple relational data points. Performance Requirements: Must handle 10,000 concurrent users with minimal latency."',
  ],
};

export default developOptimisticUIPatternsPrompt;
