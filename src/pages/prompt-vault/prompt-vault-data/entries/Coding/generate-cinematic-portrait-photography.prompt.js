const generateCinematicPortraitPhotographyPrompt = {
  emoji: '🕯️',
  title: 'Generate Cinematic Portrait Photography',
  description: 'Generate stunning cinematic portraits with this AI prompt, featuring professional lighting, realistic details, customizable subjects, and dreamy atmospheric effects.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'Nano Banana',
  output: 'Image',
  ...
  howToUse: [
    'Fill in the [SUBJECT], [TIME OF DAY], and [ATTIRE] variables with your specific details for this AI image prompt.',
    'Example: Ultra-realistic cinematic portrait of a young woman, standing alone in quiet golden hour. Gentle, thoughtful expression glowing in soft ambient light. Wearing casual denim jacket, textured messy hair, glasses, smartwatch. Shot on DSLR 85mm lens, shallow depth, HDR lighting, warm dapple backlight, dreamy dramatic bokeh, soft lens flare, high-contrast shadows, subtle atmospheric haze. Ultra-clean professional Photoshop finish, poetic dreamy romantic mood. The subject has an appearance similar to the uploaded reference image.',
  ],
};

export default generateCinematicPortraitPhotographyPrompt;
