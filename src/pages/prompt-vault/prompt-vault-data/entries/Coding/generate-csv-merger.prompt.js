const generateCSVMergerPrompt = {
  emoji: '🧩',
  title: 'Generate CSV Merger',
  description: 'Merge CSV files seamlessly with this AI prompt, ensuring data integrity and alignment with Tidy Data principles.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
export default generateCSVMergerPrompt;
