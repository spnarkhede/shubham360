const generateEnvironmentSetupScriptsPrompt = {
  emoji: '🛠️',
  title: 'Generate Environment Setup Scripts',
  description: 'Create robust DevOps scripts with this AI prompt, ensuring seamless infrastructure setup and management.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your response with clear script sections, include comprehensive comments within the code, and provide setup documentation in markdown format for maximum clarity and team adoption.`,
  ...
  howToUse: [
    'Fill in the [INSERT YOUR TARGET OS - Windows/macOS/Linux], [INSERT LIST OF SOFTWARE PACKAGES AND TOOLS NEEDED], [INSERT PROGRAMMING LANGUAGES WITH SPECIFIC VERSIONS], [INSERT DEVELOPMENT TOOLS, EDITORS, AND IDES REQUIRED], and [INSERT SPECIFIC CONFIGURATION SETTINGS AND PREFERENCES] placeholders with your specific environment details.',
    'Example: "My target operating system is Linux. My required software packages include Docker, Kubernetes, and Jenkins. My programming languages and versions are Python 3.8 and Node.js 14. My development tools and IDEs are Visual Studio Code and IntelliJ IDEA. My configuration preferences include specific environment variables and network settings."',
  ],
};

export default generateEnvironmentSetupScriptsPrompt;
