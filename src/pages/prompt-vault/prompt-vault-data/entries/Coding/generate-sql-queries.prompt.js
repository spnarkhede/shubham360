const generateSQLQueriesPrompt = {
  emoji: '🛠️',
  title: 'Generate SQL Queries',
  description: 'Create optimized SQL queries with this AI prompt, adhering to Joe Celko\'s SQL Programming Style for readability and performance.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Alternative approaches if applicable`,
  whatItDoes: [
    ...
    'Follows Joe Celko\'s SQL Programming Style to prevent future maintenance issues.',
  ],
  tips: [
  ...
  howToUse: [
    ...
    'Example: "My database schema includes tables for employees, departments, and salaries. I need a query that retrieves employee names and their department names, optimized for a database with over 10 million records."',
  ],
};

export default generateSQLQueriesPrompt;
