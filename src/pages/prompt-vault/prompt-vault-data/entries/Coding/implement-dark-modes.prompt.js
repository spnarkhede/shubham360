const implementDarkModesPrompt = {
  emoji: '🌗',
  title: 'Implement Dark Modes',
  description: 'Ensure WCAG 2.1 compliance with this AI prompt, offering a systematic approach to implementing accessible light and dark modes.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Provide implementation as structured code blocks with inline comments explaining accessibility decisions. Include a testing checklist with specific tools and validation steps. Create a color mapping table showing original colors, dark mode equivalents, and their contrast ratios. Add troubleshooting section for common accessibility failures in dark mode implementations.`,
  ...
  howToUse: [
    ...
    'Example: "My brand colors are blue (#0056b3) and white (#ffffff). I support modern browsers like Chrome, Firefox, and Safari. My current styling approach uses Tailwind CSS. My user base includes visually impaired users, so accessibility is crucial. I prefer automatic system preference detection."',
  ],
};

export default implementDarkModesPrompt;
