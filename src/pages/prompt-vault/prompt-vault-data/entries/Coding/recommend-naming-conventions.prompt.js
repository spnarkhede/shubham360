const recommendNamingConventionsPrompt = {
  emoji: '🛠️',
  title: 'Recommend Naming Conventions',
  description: 'Create comprehensive naming conventions with this AI prompt, enhancing code readability and maintainability across development teams.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your response with clear headings for each code element type (Variables, Functions, Classes, Files, Folders) and provide specific examples in bullet point format with explanations for maximum clarity and implementation.`,
  ...
  tips: [
    'Analyze your development environment and existing naming conventions to tailor guidelines that fit your team\'s needs and preferences.',
    'Engage your team in discussions about naming conventions to ensure buy-in and consistency across all code elements.',
    'Regularly review and update your naming guidelines to adapt to changes in project scope, team dynamics, or programming languages.',
  ],
  howToUse: [
    'Fill in the [INSERT PRIMARY PROGRAMMING LANGUAGE(S)], [INSERT PROJECT TYPE], [DESCRIBE ANY CURRENT NAMING CONVENTIONS OR PATTERNS], [INSERT TEAM SIZE AND GENERAL EXPERIENCE LEVEL], and [INSERT ANY PARTICULAR NAMING ISSUES YOU\'RE FACING] placeholders with specific details about your programming context and team.',
    'Example: "My primary programming language is Python. My project type is a web app. We currently use camelCase for variables and functions but lack consistency in file naming. Our team size is 10, with a mix of junior and senior developers. We face challenges with naming conventions for new modules."',
  ],
};

export default recommendNamingConventionsPrompt;
