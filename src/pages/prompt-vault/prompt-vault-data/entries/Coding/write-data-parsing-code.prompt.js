const writeDataParsingCodePrompt = {
  emoji: '🛡️',
  title: 'Write Data Parsing Code',
  description: 'Create robust data parsing solutions with this AI prompt, ensuring data integrity amidst chaotic real-world inputs.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Performance considerations for large-scale data processing`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [INSERT DATA FORMAT], [DESCRIBE EXPECTED STRUCTURE], [LIST REQUIRED FIELDS], [LIST OPTIONAL FIELDS], and [DESCRIBE STRATEGY] placeholders with specific details about your data source and handling strategy.',
    'Example: "My data source format is JSON. My expected data structure includes user profiles with required fields like \'id\', \'name\', and optional fields like \'email\'. My malformed data handling strategy involves logging errors and using default values for missing fields."',
  ],
};

export default writeDataParsingCodePrompt;
