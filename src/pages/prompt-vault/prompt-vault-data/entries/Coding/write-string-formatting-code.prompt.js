const writeStringFormattingCodePrompt = {
  emoji: '🌍',
  title: 'Write String Formatting Code',
  description: 'Create internationalization-compliant string formatting code with this AI prompt, ensuring multi-byte character support, locale-aware formatting, and security context compliance.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Error handling examples showing graceful degradation`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE THE DATA BEING FORMATTED], [SPECIFY WHERE THE FORMATTED STRING WILL BE USED], [LIST TARGET LOCALES/LANGUAGES], and [SPECIFY PROGRAMMING LANGUAGE] placeholders with specific details about your data, output context, locales, and programming language.',
    'Example: "My data to format includes user names and transaction amounts. The formatted string will be used in email notifications. Target locales include en-US, fr-FR, and ja-JP. The programming language is JavaScript."',
  ],
};

export default writeStringFormattingCodePrompt;
