const adaptKnowledgeBaseToNewMarketsPrompt = {
  emoji: '🪡',
...
DELIVERABLE 3: LOCALIZATION BRIEF FOR TRANSLATION TEAM`,
  whatItDoes: [
    'Analyzes knowledge base articles to identify elements requiring cultural adaptation beyond translation.',
    'Rewrites source content into localization-friendly language with clear bracketed local notes.',
    'Creates a detailed localization brief for tone, terminology, compliance, and market requirements.',
  ],
  tips: [
    'Prioritize high-traffic or high-impact articles first to maximize localization ROI.',
    'Validate outputs with native reviewers from the target market before publishing.',
    'Use the generated localization brief as a reusable template for future markets.',
  ],
  howToUse: [
    'Fill [PASTE ARTICLE], [COUNTRY/REGION], [LANGUAGE], and product-difference placeholders.',
    'Run the prompt and review Deliverables 1 to 3 end-to-end before translation begins.',
  ],
};

export default adaptKnowledgeBaseToNewMarketsPrompt;
