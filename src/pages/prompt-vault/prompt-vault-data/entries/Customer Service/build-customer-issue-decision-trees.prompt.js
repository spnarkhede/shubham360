const buildCustomerIssueDecisionTreesPrompt = {
  emoji: '🛤️',
...
Flag trees with more than 15 terminal nodes as requiring subdivision.`,
  ...
  howToUse: [
    'Provide issue scope, known fixes, escalation team, and user skill level.',
    'Run prompt and test tree flow with real support scenarios.',
  ],
};

export default buildCustomerIssueDecisionTreesPrompt;
