const buildKnowledgeBaseImprovementLoopsPrompt = {
  emoji: '🧬',
  title: 'Build Knowledge Base Improvement Loops',
  description: 'Design feedback systems with this AI prompt, capturing customer, agent, and analytics signals to improve knowledge base content continuously.',
  type: 'Prompts',
...
Use clear headings, bullet points, and tables where appropriate. Avoid XML tags. Ensure all components are immediately actionable without additional interpretation.`,
  ...
  howToUse: [
    'Fill in the [PLATFORM], [LIST TOOLS, e.g., Zendesk, Intercom, Freshdesk], [SLACK / TEAMS / OTHER], and [DESCRIBE OR SAY "NONE EXISTS"] placeholders with your specific knowledge base platform, support tools, team communication method, and current feedback process details.',
    'Example: "My KB platform is Zendesk Guide. My support tools are Zendesk Support, Intercom, and Google Analytics. My team communication is Slack. My current feedback process is we have article ratings enabled but no one reviews them regularly."',
  ],
};

export default buildKnowledgeBaseImprovementLoopsPrompt;
