const buildFullStackSoftwareArchitecturesPrompt = {
  emoji: '🏗️',
  title: 'Build Full-Stack Software Architectures',
  description: 'Generate production-grade full-stack applications with this AI prompt, including architecture adherence, type-safe code, testing, security, and deployment configurations.',
  type: 'Prompts',
  category: 'General',
  tool: 'Claude',
  output: 'Text',
...
✓ [other relevant security measures]
  ...
  tips: [
    ...
    'Use this AI prompt iteratively by starting with small, isolated features first, validating the AI\'s understanding of your architecture before moving to complex integrations that span multiple layers of your application.',
    'After the AI generates code using this prompt, conduct thorough code reviews focusing on security vulnerabilities and architectural consistency, then feed any corrections back to refine the AI\'s understanding of your specific requirements.',
  ],
  howToUse: [
    'Fill in the [ARCHITECTURE], [TECH_STACK], [PROJECT], and [STANDARDS] placeholders with your specific system design documentation, technology choices, project description, and coding rules.',
    'Example: For [ARCHITECTURE], describe your folder structure like "frontend uses /src/components for React components, backend uses /api for routes"; for [TECH_STACK], list "React, Node.js, PostgreSQL"; for [PROJECT], write "Building an e-commerce platform, current task is user authentication"; for [STANDARDS], specify "Use TypeScript strict mode, ESLint Airbnb config".',
  ],
};

export default buildFullStackSoftwareArchitecturesPrompt;
