const getPreciseCookingRecipesPrompt = {
  emoji: '🔍',
  title: 'Get Precise Cooking Recipes',
  description: 'Create precise, reproducible recipes with this AI prompt, eliminating ambiguity for consistent culinary success.',
  type: 'Prompts',
...
\`\`\``,
  whatItDoes: [
    ...
    'Provides a comprehensive recipe tailored to the user\'s chosen complexity level, ensuring consistent results.',
    'Offers a structured approach to cooking with exact measurements and clear instructions for each step.',
  ],
  tips: [
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DISH NAME], [NUMBER OF PEOPLE], and [SIMPLE/SPECIAL/LUXURY] placeholders with your specific dish name, serving size, and desired complexity level.',
    'Example: "My dish name is \'Beef Wellington\', my number of servings is 4, and my recipe complexity is \'Luxury\'."',
  ],
};

export default getPreciseCookingRecipesPrompt;
