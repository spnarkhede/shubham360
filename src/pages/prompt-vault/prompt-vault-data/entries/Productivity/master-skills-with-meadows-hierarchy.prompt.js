const masterSkillsWithMeadowsHierarchyPrompt = {
  emoji: '🌀',
  title: 'Master Skills With Meadows\' Hierarchy',
  description: 'Master complex skills with this AI prompt, leveraging systems thinking to identify high-impact interventions for exponential growth.',
  type: 'Prompts',
...
| Rank | Leverage Point | Change | Expected Multiplier | Monitoring Plan (3 Metrics) | Pilot Actions (First 7 Days) |`,
  whatItDoes: [
    'Identifies hidden leverage points in skill acquisition to create exponential improvements.',
    'Maps skill learning as a complex adaptive system, focusing on high-impact interventions.',
    'Provides specific, actionable steps with measurable metrics to track progress.',
  ],
  tips: [
    'Break down your skill into smaller components and identify which parts can be improved with minimal effort for maximum impact.',
    'Use feedback loops to continuously refine your approach, ensuring you\'re always moving towards your target outcome.',
    'Prioritize interventions that align with your constraints, focusing on mental models and system dynamics rather than surface behaviors.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [SKILL], [CONSTRAINTS], and [TARGET_OUTCOME] placeholders with the specific skill you want to master, the limitations you\'re facing, and the outcome you aim to achieve.',
    'Example: "My skill to master is advanced data analysis. My constraints are limited time and resources. My target outcome is to become proficient in data-driven decision-making within three months."',
  ],
};

export default masterSkillsWithMeadowsHierarchyPrompt;
