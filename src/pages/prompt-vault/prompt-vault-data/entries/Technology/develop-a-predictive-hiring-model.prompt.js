const developAPredictiveHiringModelPrompt = {
  emoji: '🤖',
  title: 'Develop A Predictive Hiring Model',
  description: 'How can I develop a predictive hiring model to improve talent acquisition processes?',
  type: 'Prompts',
  category: 'Technology',
  tool: 'ChatGPT',
  output: 'Text',
...
export default developAPredictiveHiringModelPrompt;
