const developRobustBusinessContinuityFrameworkPrompt = {
  emoji: '☁️',
  title: 'Develop Robust Business Continuity Framework',
  description: 'To develop a robust business continuity framework for cloud services, let\'s break down the process into foundational components, best practices, and strategies',
  type: 'Prompts',
  category: 'Technology',
  tool: 'ChatGPT',
  output: 'Text',
...
export default developRobustBusinessContinuityFrameworkPrompt;
