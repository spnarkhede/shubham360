const analyzePerformanceBottlenecksPrompt = {
  emoji: '⚙️',
  title: 'Analyze Performance Bottlenecks',
  description: 'Identify performance bottlenecks with this AI prompt, focusing on profiling-driven analysis for real-world impact.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<implementation_priority>Guidance on which option to implement first based on impact and complexity</implementation_priority>
  ...
  howToUse: [
    'Fill in the [PASTE THE CODE THAT NEEDS PERFORMANCE ANALYSIS], [DESCRIBE HOW THE CODE WILL BE USED IN PRODUCTION], [SPECIFY PERFORMANCE TARGETS OR CONSTRAINTS], [DESCRIBE THE RUNTIME ENVIRONMENT AND CONSTRAINTS], and [SPECIFY MEMORY, CPU, AND OTHER RESOURCE LIMITATIONS] placeholders with specific details about your code and environment.',
    'Example: "The code to profile is a data processing module. It will be used in a high-traffic web application. Performance targets include reducing response time to under 200ms. The current environment is a cloud-based server with limited CPU resources."',
  ],
};

export default analyzePerformanceBottlenecksPrompt;
