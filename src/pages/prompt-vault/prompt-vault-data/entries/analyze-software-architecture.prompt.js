const analyzeSoftwareArchitecturePrompt = {
  emoji: '🗺️',
  title: 'Analyze Software Architecture',
  description: 'Guide developers through understanding software architecture with this AI prompt, using C4 model principles to map codebases effectively.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Would you like to analyze another file or explore specific aspects deeper? Type "continue" or specify your need.`,
  ...
  tips: [
    ...
    'Tailor your approach based on the project\'s architecture style and the developer\'s experience to maximize clarity and effectiveness.',
  ],
  howToUse: [
    'Run the full prompt and answer the questions as detailed as possible.',
    'Example: "Provide the file path, project type, and reason for interest in the file for Phase 1 analysis."',
  ],
};

export default analyzeSoftwareArchitecturePrompt;
