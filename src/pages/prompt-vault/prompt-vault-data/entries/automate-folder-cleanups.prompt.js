const automateFolderCleanupsPrompt = {
  emoji: '🧹',
  title: 'Automate Folder Cleanups',
  description: 'Create an automated digital decluttering system with this AI prompt, designed to organize files efficiently while safeguarding critical data.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- A troubleshooting section for common issues`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [LIST SPECIFIC FOLDERS TO CLEAN], [NUMBER OF DAYS FILES SHOULD REMAIN], [FILE TYPES/NAMES THAT SHOULD NEVER BE AUTO-DELETED], [WHERE ARCHIVED FILES SHOULD BE MOVED], and [WHEN AUTOMATION SHOULD RUN] placeholders with your specific details.',
    'Example: "My target folders are \'Work Projects\' and \'Personal Documents\'. My retention period is 90 days. My critical file patterns include \'.pdf\' and \'tax_*.xls\'. My archival location is \'External Drive/Archives\'. My cleanup schedule is every Sunday at 3 AM."',
  ],
};

export default automateFolderCleanupsPrompt;
