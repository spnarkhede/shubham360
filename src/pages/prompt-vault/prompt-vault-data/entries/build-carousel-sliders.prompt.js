const buildCarouselSlidersPrompt = {
  emoji: '🎠',
  title: 'Build Carousel Sliders',
  description: 'Create a user-friendly carousel slider with this AI prompt, ensuring accessibility and usability based on Nielsen Norman Group guidelines.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Testing checklist for usability and accessibility verification`,
  ...
  tips: [
    ...
    'Conduct user testing to gather feedback on the carousel\'s usability and accessibility, refining the implementation based on real-world interactions.',
    'Regularly update and maintain the carousel to ensure it remains compliant with the latest accessibility standards and user expectations.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE WHAT CONTENT WILL BE IN THE CAROUSEL], [YES/NO - IF YES, SPECIFY TIMING], [DESCRIBE WHO WILL USE THIS CAROUSEL], [ANY SPECIFIC ACCESSIBILITY NEEDS], and [SPECIFY TECHNOLOGY STACK IF RELEVANT] placeholders with your specific content details, autoplay preferences, target audience, accessibility needs, and technology stack.',
    'Example: "My slide content includes product images and descriptions. My autoplay preference is \'Yes\' with a 5-second interval. My target audience is visually impaired users. My accessibility requirements include screen reader support. My platform/framework is React."',
  ],
};

export default buildCarouselSlidersPrompt;
