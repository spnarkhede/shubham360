const buildExcelToCSVConverterPrompt = {
  emoji: '🛠️',
  title: 'Build Excel To CSV Converter',
  description: 'Create a robust Excel to CSV conversion script with this AI prompt, ensuring data integrity and handling edge cases gracefully.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Step-by-step execution flow`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [INSERT EXCEL FILE PATHS], [SPECIFY SHEET NAMES OR INDICES], and [INSERT OUTPUT DIRECTORY PATH] placeholders with your specific file paths, sheet names or indices, and output directory path.',
    'Example: "My workbook paths: [\'C:/Users/Example/Documents/Workbook1.xlsx\', \'C:/Users/Example/Documents/Workbook2.xlsx\'], My target sheets: [\'Sheet1\', \'Sheet2\'], My output directory: \'C:/Users/Example/Documents/CSVOutput\'"',
  ],
};

export default buildExcelToCSVConverterPrompt;
