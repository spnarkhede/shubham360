const buildFileSortingSystemPrompt = {
  emoji: '🌪️',
  title: 'Build File Sorting System',
  description: 'Create a comprehensive file sorting system with this AI prompt, transforming digital chaos into an intuitive, self-maintaining organizational structure.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Use clear headings, code blocks for scripts, and bullet points for rules and criteria. Include visual representations of the before/after folder structure where helpful.`,
  whatItDoes: [
    'Analyzes the user\'s chaotic file system to identify disorganization patterns.',
    'Maps the desired organizational structure to GTD principles, creating a sustainable order.',
    'Designs intelligent sorting rules and scripts that adapt to user behavior and maintain file integrity.',
  ],
  tips: [
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE YOUR CURRENT FOLDER CHAOS], [DESCRIBE YOUR IDEAL ORGANIZATIONAL STRUCTURE], and [LIST MAIN FILE TYPES YOU WORK WITH] placeholders with specific details about your current file situation and goals.',
    'Example: "My current folder chaos involves a mix of personal and work files with no clear separation. My ideal structure includes separate folders for work projects and personal documents, organized by GTD contexts. I primarily work with PDF, DOCX, and JPEG files."',
  ],
};

export default buildFileSortingSystemPrompt;
