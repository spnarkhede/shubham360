const buildGraphQLQueriesPrompt = {
  emoji: '🔍',
  title: 'Build GraphQL Queries',
  description: 'Craft precise GraphQL queries with this AI prompt, ensuring efficient data retrieval and robust error handling.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
export default buildGraphQLQueriesPrompt;
