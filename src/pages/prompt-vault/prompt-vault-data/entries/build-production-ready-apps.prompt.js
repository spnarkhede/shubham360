const buildProductionReadyAppsPrompt = {
  emoji: '🛠️',
  title: 'Build Production-Ready Apps',
  description: 'Build robust applications with this AI prompt, ensuring complete functionality, professional UI, and seamless user experience.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<deployment_guide>Instructions for running, testing, and deploying the application</deployment_guide>
  ...
  tips: [
    'Define clear objectives for the app\'s purpose and target users to ensure alignment with business goals and user needs.',
    'Conduct thorough research on design preferences and technical requirements to create a cohesive and professional application.',
    'Continuously test and gather feedback during development to refine features and improve user experience.',
  ],
  howToUse: [
    'Fill in the [DESCRIBE THE MAIN PURPOSE AND GOAL OF THE APPLICATION], [DEFINE WHO WILL BE USING THIS APPLICATION], [LIST THE ESSENTIAL FEATURES AND FUNCTIONALITY NEEDED], [SPECIFY ANY DESIGN STYLE, COLOR SCHEME, OR UI PREFERENCES], and [ANY SPECIFIC TECHNICAL REQUIREMENTS OR CONSTRAINTS] placeholders with specific details about your application needs.',
    'Example: "The main purpose of the application is to streamline project management for remote teams. The target users are project managers and team members. Essential features include task tracking, real-time collaboration, and reporting dashboards. Design preferences include a minimalist style with a blue and white color scheme. Special requirements include integration with existing CRM systems."',
  ],
};

export default buildProductionReadyAppsPrompt;
