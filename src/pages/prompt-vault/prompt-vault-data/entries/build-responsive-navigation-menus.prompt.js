const buildResponsiveNavigationMenusPrompt = {
  emoji: '🧭',
  title: 'Build Responsive Navigation Menus',
  description: 'Create a responsive navigation menu with this AI prompt, balancing modern design trends with established usability principles.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Browser compatibility notes`,
  whatItDoes: [
    ...
    'Ensures the navigation menu adheres to Jakob\'s Law, enhancing user experience by following familiar patterns.',
    'Guides in creating a mobile-first design with accessibility compliance and smooth transitions.',
  ],
  tips: [
    'Start by mapping out your site\'s structure and content hierarchy to ensure the navigation menu aligns with user expectations and industry conventions.',
    'Focus on creating a mobile-first design with a recognizable hamburger menu, then enhance it for desktop with dropdowns and hover states.',
    'Regularly test the navigation menu with real users to gather feedback and make necessary adjustments for improved usability and accessibility.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE YOUR SITE HIERARCHY AND MAIN SECTIONS], [SPECIFY HOW MANY TOP-LEVEL MENU ITEMS], [DESCRIBE YOUR USERS AND THEIR TECHNICAL COMFORT LEVEL], [DESCRIBE VISUAL STYLE CONSTRAINTS OR PREFERENCES], and [SPECIFY INDUSTRY/PURPOSE - E.G., E-COMMERCE, BLOG, SAAS] placeholders with specific details about your website.',
    'Example: "My site hierarchy includes Home, About, Services, Blog, and Contact sections. I have 5 top-level menu items. My target audience is tech-savvy millennials familiar with online shopping. My brand style is minimalist with a focus on clean lines. My site type is an e-commerce platform."',
  ],
};

export default buildResponsiveNavigationMenusPrompt;
