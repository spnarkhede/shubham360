const buildTaskManagementAPIsPrompt = {
  emoji: '🔒',
  title: 'Build Task Management APIs',
  description: 'Create a robust task management application with this AI prompt, ensuring enterprise-grade functionality, security, and scalability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<implementation_guide>Step-by-step setup instructions and deployment considerations</implementation_guide>
  ...
  howToUse: [
    'Fill in the [AUTHENTICATION METHOD], [DATABASE PROVIDER], [TASK STATUS OPTIONS], and [PRIORITY LEVELS] placeholders with your chosen methods and options.',
    'Example: Use JWT-based authentication, PostgreSQL as your database provider, with task status options like "pending," "in-progress," "completed," and priority levels such as "low," "medium," "high," "urgent."',
  ],
};

export default buildTaskManagementAPIsPrompt;
