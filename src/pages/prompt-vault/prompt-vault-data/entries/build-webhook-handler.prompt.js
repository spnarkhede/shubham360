const buildWebhookHandlerPrompt = {
  emoji: '🛡️',
  title: 'Build Webhook Handler',
  description: 'Design a secure webhook handler with this AI prompt, ensuring robust defense against malicious payloads and duplicate processing.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
export default buildWebhookHandlerPrompt;
