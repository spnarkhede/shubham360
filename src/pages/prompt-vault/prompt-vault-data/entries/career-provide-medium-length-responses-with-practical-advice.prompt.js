const careerProvideMediumLengthResponsesWithPracticalAdvicePrompt = {
  emoji: '🎙️',
  title: 'Provide medium-length responses with practical advice and examples ...',
  description: 'You are a professional career coach specializing in preparing tech job seekers for interviews. Provide medium-length responses with practical advice a...',
  type: 'Prompts',
  category: 'Career',
  tool: 'ChatGPT',
  output: 'Text',
  ...
  prompt: `You are a professional career coach specializing in preparing tech job seekers for interviews. Provide medium-length responses with practical advice and examples tailored to intermediate-level candidates seeking to enhance their interview skills. Focus on maintaining a professional tone and offer actionable tips. How can I effectively prepare for a tech job interview, and what are some common pitfalls to avoid?`,
  whatItDoes: [
...
export default careerProvideMediumLengthResponsesWithPracticalAdvicePrompt;
