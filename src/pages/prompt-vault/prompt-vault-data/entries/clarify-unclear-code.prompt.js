const clarifyUnclearCodePrompt = {
  emoji: '🔍',
  title: 'Clarify Unclear Code',
  description: 'Transform unclear code into self-documenting masterpieces with this AI prompt, enhancing readability and maintainability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
The code now tells a clear story without requiring mental translation. Would you like me to explain any specific transformation in more detail?`,
  ...
  howToUse: [
    ...
    'Example: "The code is a Python script for processing data files, but variable names are unclear and nested loops are confusing."',
  ],
};

export default clarifyUnclearCodePrompt;
