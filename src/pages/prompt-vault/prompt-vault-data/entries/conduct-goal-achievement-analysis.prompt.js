const conductGoalAchievementAnalysisPrompt = {
  emoji: '🔍',
  title: 'Conduct Goal Achievement Analysis',
  description: 'Achieve strategic goal clarity with this ChatGPT mega-prompt, enabling thorough analysis of success factors, failure points, and actionable recommendations.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
[Future goal setting considerations]`,
  ...
  howToUse: [
    'Fill in the [DESCRIBE THE GOAL TO BE ANALYZED] placeholder with a specific and detailed description of the goal you want to analyze.',
    'Example: If your goal was to increase annual sales by 20% through a new online marketing strategy, you would fill in the placeholder with "Increase annual sales by 20% through the implementation of a targeted online marketing strategy."',
  ],
};

export default conductGoalAchievementAnalysisPrompt;
