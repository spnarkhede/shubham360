const convertXMLToJSONPrompt = {
  emoji: '🔄',
  title: 'Convert XML to JSON',
  description: 'Analyze XML-to-JSON conversion with this AI prompt, focusing on structured data migration, API integration, and data interoperability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
export default convertXMLToJSONPrompt;
