const designADevsecopsImplementationRoadmapPrompt = {
  emoji: '⚙️',
  title: 'Design A Devsecops Implementation Roadmap',
  description: 'How can I design a DevSecOps implementation roadmap that effectively integrates security into the development and operations lifecycle while ensuring continuous improvement and automation?',
  type: 'Prompts',
  category: 'Technology',
  tool: 'Claude',
  output: 'Text',
...
export default designADevsecopsImplementationRoadmapPrompt;
