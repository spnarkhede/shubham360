const designAServerlessArchitecturePrompt = {
  emoji: '☁️',
  title: 'Design A Serverless Architecture',
  description: 'How can I design a serverless architecture for real-time analytics that ensures high availability and low latency?',
  type: 'Prompts',
  category: 'Technology',
  tool: 'ChatGPT',
  output: 'Text',
...
export default designAServerlessArchitecturePrompt;
