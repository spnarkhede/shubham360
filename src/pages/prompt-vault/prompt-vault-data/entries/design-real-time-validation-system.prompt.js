const designRealTimeValidationSystemPrompt = {
  emoji: '🛠️',
  title: 'Design Real-Time Validation System',
  description: 'Enhance user experience with this AI prompt, focusing on real-time form validation to reduce abandonment rates and improve conversion.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
<testing_optimization_plan>A/B testing strategies and metrics for measuring validation effectiveness</testing_optimization_plan>
  ...
  howToUse: [
    'Fill in the [TYPE OF APPLICATION], [CURRENT TECH STACK], [TARGET USER BASE], [CRITICAL FORM TYPES], and [EXISTING CONSTRAINTS] placeholders with specific details about your application and its environment.',
    'Example: "The application is an e-commerce platform using React and Node.js. The target users are tech-savvy millennials. Critical forms include checkout and signup, with constraints around legacy system integration."',
  ],
};

export default designRealTimeValidationSystemPrompt;
