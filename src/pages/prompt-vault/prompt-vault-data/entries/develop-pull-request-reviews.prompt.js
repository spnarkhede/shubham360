const developPullRequestReviewsPrompt = {
  emoji: '🛠️',
  title: 'Develop Pull Request Reviews',
  description: 'Guide comprehensive pull request reviews with this AI prompt, ensuring code correctness, clarity, design quality, and maintainability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Type "export" for shareable review format or "discuss" to dive deeper into any feedback.`,
  ...
  howToUse: [
    ...
    'Example: "This is a feature change that aims to improve user login speed by optimizing database queries. The PR changes 150 lines of code and touches the authentication module."',
  ],
};

export default developPullRequestReviewsPrompt;
