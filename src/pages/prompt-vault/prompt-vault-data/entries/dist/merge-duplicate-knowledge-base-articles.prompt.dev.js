...
var mergeDuplicateKnowledgeBaseArticlesPrompt = {
  emoji: '⚗️',
  ...
  whatItDoes: ['Combines duplicate KB articles into one consistent single source of truth.', 'Tracks keep/cut/merge decisions with rationale for auditability.', 'Flags contradictions that require human decision before publication.'],
  tips: ['Include full article text to improve contradiction and overlap detection.', 'Have subject matter owners review flagged contradictions before final merge.', 'Preserve merge reports as governance artifacts to prevent duplicate re-creation.'],
  howToUse: ['Paste 2-3 source articles and any style constraints.', 'Run prompt, publish merged article, and archive merge report.']
};
var _default = mergeDuplicateKnowledgeBaseArticlesPrompt;
