const draftProductRequirementsPrompt = {
  emoji: '🔍',
  title: 'Draft Product Requirements',
  description: 'Create a comprehensive Product Requirements Document with this AI prompt, emphasizing problem definition over solution prescription.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your output with clear PRD sections including Problem Statement, User Needs, Success Metrics, User Stories, and Constraints. Use bullet points within each section for maximum clarity and stakeholder alignment.`,
  whatItDoes: [
    ...
    'Structures the PRD using Marty Cagan\'s framework, ensuring logical flow from user research insights to actionable objectives.',
  ],
  tips: [
  ...
  howToUse: [
    'Fill in the [INSERT YOUR PRODUCT VISION STATEMENT], [INSERT YOUR KEY METRICS AND GOALS], [INSERT YOUR USER RESEARCH FINDINGS AND INSIGHTS], [INSERT YOUR TECHNICAL, BUDGET, OR TIMELINE CONSTRAINTS], and [INSERT YOUR PRIMARY USER PERSONAS OR SEGMENTS] placeholders with specific information about your product vision, success metrics, user research, constraints, and target users.',
    'Example: "My product vision is to create an intuitive project management tool that enhances team collaboration. My target success metrics include increasing user engagement by 20% and reducing task completion time by 15%. My user research data shows that users struggle with task prioritization and communication. My business constraints include a limited budget and a six-month timeline. My target user segments are small to medium-sized business teams looking for efficient project management solutions."',
  ],
};

export default draftProductRequirementsPrompt;
