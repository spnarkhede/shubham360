const enhanceCodeReadabilityPrompt = {
  emoji: '🛠️',
  title: 'Enhance Code Readability',
  description: 'Transform your codebase with this AI prompt, applying Clean Code principles to enhance readability and maintainability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Future development advantages`,
  ...
  howToUse: [
    ...
    'Example: "My code section: [INSERT CODE TO BE REFACTORED]. My code\'s purpose: [DESCRIBE WHAT THIS CODE SHOULD ACCOMPLISH]. My specific concerns: [OPTIONAL: SPECIFIC AREAS YOU\'RE WORRIED ABOUT]."',
  ],
};

export default enhanceCodeReadabilityPrompt;
