const fixProblematicCodePrompt = {
  emoji: '🔍',
  title: 'Fix Problematic Code',
  description: 'Transform problematic code into maintainable solutions with this AI prompt, focusing on refactoring patterns and code quality.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Type "start" to begin with Phase 1.`,
  ...
  tips: [
    'Familiarize yourself with Martin Fowler\'s refactoring patterns to better understand the suggested transformations and their benefits.',
    'Start with simpler refactoring tasks to build confidence and gradually tackle more complex issues as you become more comfortable with the process.',
    'Use code analysis tools to assist in identifying code smells and tracking improvements over time, ensuring continuous code quality enhancement.',
  ],
  howToUse: [
    'Run the full prompt and answer the questions as detailed as possible.',
    'Example: "Paste your code and describe any specific concerns or problematic areas you feel need attention, along with your comfort level with refactoring."',
  ],
};

export default fixProblematicCodePrompt;
