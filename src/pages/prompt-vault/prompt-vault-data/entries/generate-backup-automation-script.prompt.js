const generateBackupAutomationScriptPrompt = {
  emoji: '🛡️',
  title: 'Generate Backup Automation Script',
  description: 'Create robust backup automation scripts with this AI prompt, ensuring data integrity and recovery reliability.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Use code blocks for scripts, tables for configuration options, and numbered lists for procedures.`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [LIST SOURCE DIRECTORIES TO BACKUP], [SPECIFY LOCAL, NETWORK, AND OFFSITE LOCATIONS], and [DEFINE HOW LONG TO KEEP DIFFERENT BACKUP TYPES] placeholders with your specific directories, backup locations, and retention policies.',
    'Example: "My source directories are /home/user/documents and /var/www/html. My backup destinations include a local NAS, a remote server, and a cloud service. I keep daily backups for 7 days, weekly for 4 weeks, and monthly for 12 months."',
  ],
};

export default generateBackupAutomationScriptPrompt;
