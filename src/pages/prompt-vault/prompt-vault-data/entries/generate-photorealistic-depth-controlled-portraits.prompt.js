const generatePhotorealisticDepthControlledPortraitsPrompt = {
  emoji: '📐',
  title: 'Generate Photorealistic Depth-Controlled Portraits',
  description: 'Generate photorealistic images with this AI prompt, using depth map control for precise pose replication, composition accuracy, and spatial positioning.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'Nano Banana',
  output: 'Image',
  ...
  whatItDoes: [
    ...
    'Creates an overhead bird\'s-eye view scene with the subject centered on a reflective polished floor in a luxurious interior setting.',
    'Uses depth map control at maximum strength to ensure precise pose replication and proper placement of props around the subject.',
  ],
  tips: [
  ...
  howToUse: [
    ...
    'Step 2: Fill in the [SUBJECT DESCRIPTION], [ACTIVITY & PROPS], and [FLOOR MATERIAL] with your specific details for the AI image prompt.',
    'Step 3: Run the JSON prompt above.',
  ],
};

export default generatePhotorealisticDepthControlledPortraitsPrompt;
