const generateTestDataSamplesPrompt = {
  emoji: '🧪',
  title: 'Generate Test Data Samples',
  description: 'Create comprehensive test data samples with this AI prompt, covering boundary values, equivalence classes, and critical edge cases.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your output in a markdown table format with columns for Test Category, Test Data Sample, Expected Behavior, Boundary Type, and Risk Level. Include clear section headers for different equivalence classes and boundary conditions.`,
  ...
  tips: [
    'Clearly define the type of application or system you are testing to tailor the test data samples effectively.',
    'Identify the primary data fields and input types that require testing, ensuring comprehensive coverage of all critical scenarios.',
    'Consider any constraints on data size, complexity, or special requirements to maintain practical usability for both automated and manual testing processes.',
  ],
  howToUse: [
    'Fill in the [INSERT THE TYPE OF APPLICATION OR SYSTEM YOU\'RE TESTING], [INSERT THE SPECIFIC DATA FIELDS OR INPUT TYPES YOU NEED TO TEST], [INSERT THE VALID RANGES, FORMATS, OR CONSTRAINTS FOR YOUR INPUTS], [INSERT THE KEY BUSINESS SCENARIOS OR USE CASES TO COVER], and [INSERT ANY CONSTRAINTS ON DATA SIZE, COMPLEXITY, OR SPECIAL REQUIREMENTS] placeholders with specific information about your testing needs.',
    'Example: "My application/system type is an e-commerce platform. My primary data fields to test include user login credentials, payment information, and product inventory. My valid input ranges/constraints are alphanumeric characters for usernames, numeric values for prices, and specific date formats for order dates. My critical business scenarios include user authentication, payment processing, and inventory updates. My testing environment limitations include a maximum data size of 1GB and a requirement for data anonymization."',
  ],
};

export default generateTestDataSamplesPrompt;
