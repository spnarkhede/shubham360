const generateWebScrapingScriptPrompt = {
  emoji: '💡',
  title: 'Generate Web Scraping Script',
  description: 'Create ethical web scraping scripts with this AI prompt, ensuring compliance with website policies and structured data extraction.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Provide your output as a complete Python script with detailed comments, followed by clear usage instructions in bullet point format. Include ethical guidelines and troubleshooting tips for common issues.`,
  ...
  howToUse: [
    'Fill in the [My target URLs to scrape], [My desired data to extract], [My preferred output format], [My rate limiting preference], and [My technical skill level] placeholders with your specific URLs, data needs, output format, delay preference, and Python experience level.',
    'Example: "My target URLs to scrape are e-commerce product pages. I want to extract product names, prices, and ratings. My preferred output format is CSV. I prefer a 5-second delay between requests. My technical skill level is intermediate with Python."',
  ],
};

export default generateWebScrapingScriptPrompt;
