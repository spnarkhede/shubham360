const identifyEdgeCaseFailuresPrompt = {
  emoji: '💡',
  title: 'Identify Edge Case Failures',
  description: 'Identify critical software vulnerabilities with this AI prompt, focusing on edge cases that standard tests overlook.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Use clear headings and bullet points for easy scanning. Include code examples or specific test values where relevant.`,
  whatItDoes: [
    'Identifies edge case conditions that could break the user\'s code in production.',
    'Explores potential edge cases systematically, focusing on boundaries and unexpected interactions.',
    'Provides insights into why these edge cases are often missed and how to test for them.',
  ],
  tips: [
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE THE SYSTEM OR COMPONENT], [LIST TECHNOLOGIES USED], and [DESCRIBE ANY KNOWN LIMITATIONS OR REQUIREMENTS] placeholders with specific details about your system, technology stack, and constraints.',
    'Example: "My system is an online banking platform. We use Java and Spring Boot. Known constraints include limited memory resources and strict security requirements."',
  ],
};

export default identifyEdgeCaseFailuresPrompt;
