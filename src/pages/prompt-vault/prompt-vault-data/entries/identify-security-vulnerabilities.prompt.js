const identifySecurityVulnerabilitiesPrompt = {
  emoji: '💣',
  title: 'Identify Security Vulnerabilities',
  description: 'Identify and fix critical security vulnerabilities with this AI prompt, ensuring robust code integrity and compliance.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
[Systematic improvements to prevent future vulnerabilities]`,
  ...
  howToUse: [
    'Fill in the [INSERT CODE SNIPPET OR SYSTEM DESCRIPTION], [SPECIFY LANGUAGE AND FRAMEWORK], [DESCRIBE DEPLOYMENT ENVIRONMENT], and [LIST COMPLIANCE OR SECURITY STANDARDS] placeholders inside #INFORMATION ABOUT ME section with specific details about your code and environment.',
    'Example: "My code snippet is a user authentication module written in Python using Django framework. It is deployed on AWS with compliance to GDPR standards."',
  ],
};

export default identifySecurityVulnerabilitiesPrompt;
