const implementStructuredLoggingPrompt = {
  emoji: '🔍',
  title: 'Implement Structured Logging',
  description: 'Implement structured logging with this AI prompt, ensuring traceability and security in distributed systems.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Use code blocks with syntax highlighting and inline comments explaining each component.`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [INSERT PROGRAMMING LANGUAGE], [INSERT LOGGING FRAMEWORK/LIBRARY], [DESCRIBE YOUR SERVICE ARCHITECTURE], [LIST SENSITIVE DATA TYPES TO SANITIZE], and [INSERT MONITORING/LOG AGGREGATION PLATFORM] placeholders with your specific details about your programming environment and architecture.',
    'Example: "My programming language is Python, using the logging framework Loguru. My service architecture is a microservices-based system with RESTful APIs. Sensitive data types include passwords and credit card numbers. My monitoring platform is Datadog."',
  ],
};

export default implementStructuredLoggingPrompt;
