const optimizeRegexPerformancePrompt = {
  emoji: '♟️',
  title: 'Optimize Regex Performance',
  description: 'Optimize regex patterns with this AI prompt, designed to prevent catastrophic backtracking and enhance system performance.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
export default optimizeRegexPerformancePrompt;
