const planCareerAdvancementGoalsPrompt = {
  emoji: '🧭',
  title: 'Plan Career Advancement Goals',
  description: 'Create a comprehensive career development plan with this AI prompt, bridging current roles with long-term aspirations through strategic goal-setting.',
  type: 'Prompts',
...
MOST IMPORTANT!: Structure your response with clear headings for each time period and provide all action items in bullet point format with specific deadlines and measurable outcomes for maximum clarity and implementation.`,
  whatItDoes: [
    'Conducts a thorough assessment of the user\'s current career stage, competencies, and aspirations.',
    'Identifies skill gaps and growth opportunities aligned with long-term career goals.',
    'Designs a comprehensive, actionable career development plan with measurable goals.',
  ],
  tips: [
    'Clearly define your current role, industry, and long-term career aspirations to ensure the plan aligns with your professional goals.',
    'Regularly review and adjust your career development plan based on progress and any new opportunities or challenges that arise.',
    'Engage with mentors and industry connections to gain insights and support, enhancing your professional network and visibility.',
  ],
  howToUse: [
    'Fill in the [INSERT YOUR CURRENT POSITION AND INDUSTRY], [INSERT YOUR MAIN COMPETENCIES AND YEARS OF EXPERIENCE], [INSERT YOUR 3-5 YEAR CAREER GOALS], [INSERT YOUR MAIN CAREER OBSTACLES OR CONCERNS], and [INSERT HOW YOU LEARN BEST AND AVAILABLE TIME COMMITMENT] placeholders with specific details about your career and learning preferences.',
    'Example: "My current role is a Marketing Manager in the tech industry. I have 5 years of experience in digital marketing and project management. My long-term goal is to become a Chief Marketing Officer within 5 years. My biggest challenge is balancing strategic planning with day-to-day operations. I prefer learning through online courses and can dedicate 5 hours a week to skill development."',
  ],
};

export default planCareerAdvancementGoalsPrompt;
