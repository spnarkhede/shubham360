const planFeatureRoadmapsPrompt = {
  emoji: '🛠️',
  title: 'Plan Feature Roadmaps',
  description: 'Create outcome-driven product roadmaps with this AI prompt, aligning features with business results and customer needs.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Include a timeline view showing theme progression and a simple prioritization matrix plotting impact vs effort. End with next steps for validation and discovery activities.`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [INSERT YOUR TOP 3-5 BUSINESS OBJECTIVES], [DESCRIBE KEY CUSTOMER PROBLEMS YOU\'VE DISCOVERED], [LIST TECHNICAL LIMITATIONS OR DEPENDENCIES], [SPECIFY PLANNING HORIZON AND KEY MILESTONES], and [DESCRIBE YOUR TEAM\'S CAPACITY] placeholders with specific details about your business context.',
    'Example: "My business objectives include increasing customer retention by 20%, launching a new product line, and improving operational efficiency. Key customer problems involve long wait times and lack of product variety. Technical constraints include limited API integration capabilities. Our planning horizon is six months with milestones for quarterly reviews. Our team consists of five developers and two designers with expertise in agile methodologies."',
  ],
};

export default planFeatureRoadmapsPrompt;
