const prioritizeTestCasesPrompt = {
  emoji: '🔍',
  title: 'Prioritize Test Cases',
  description: 'Optimize your testing strategy with this AI prompt, transforming exhaustive validation into precise, risk-based prioritization.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Visual breakdown showing percentage of testing effort per tier with specific hour/day allocations based on user's constraints.`,
  ...
  tips: [
    ...
    'Use historical defect patterns to guide your prioritization, ensuring you\'re testing where it matters most.',
    'Regularly reassess and adjust your testing priorities based on recent changes and resource availability.',
  ],
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [DESCRIBE YOUR PRODUCT/SYSTEM], [SPECIFY TEAM SIZE AND AVAILABLE TESTERS], [DEFINE YOUR RELEASE SCHEDULE/DEADLINES], [LIST TOP 5 REVENUE/USER-CRITICAL FEATURES], and [DESCRIBE SIGNIFICANT RECENT CODE CHANGES] placeholders with specific details about your product, team, and testing environment.',
    'Example: "My product is an e-commerce platform. We have a team of 5 testers. Our release schedule is bi-weekly. Our critical features include checkout, payment processing, and user authentication. Recent changes include a complete overhaul of the payment gateway integration."',
  ],
};

export default prioritizeTestCasesPrompt;
