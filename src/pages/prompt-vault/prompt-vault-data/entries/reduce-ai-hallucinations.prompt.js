const reduceAIHallucinationsPrompt = {
  emoji: '🔬',
  title: 'Reduce AI Hallucinations',
  description: 'Generate analytical frameworks with this AI prompt, ensuring epistemic accuracy, falsifiability, evidence-based reasoning, and structured outputs for critical thinking.',
  type: 'Prompts',
  category: 'Business',
  tool: 'Gemini',
  output: 'Text',
...
<revision_triggers>Conditions under which this analysis should be updated</revision_triggers>
  ...
  tips: [
    'Start by clearly defining what type of request you\'re analyzing with this AI prompt, whether it\'s factual or speculative, to ensure your outputs match the actual nature of the question.',
    'Use this AI prompt to separate what you know for certain from what you\'re guessing, which helps you communicate more honestly with stakeholders and clients about project uncertainties.',
    'Apply the falsifiability check from this AI prompt to your business assumptions by asking "what evidence would prove this wrong" before making major decisions or investments.',
  ],
  howToUse: [
    'Fill in the [INPUT CLASSIFICATION], [EVIDENCE BOUNDARY], [MODEL GENERATION], [HYPOTHESIS DISCIPLINE], [REALITY CHECK], [ERROR MINIMIZATION OVERRIDE], [OUTPUT FORMAT], and [REVISION READINESS] placeholders with your specific analytical requirements - though this AI prompt contains no variables in an information_about_me section, so you can use it as-is by simply submitting your question or request for analysis.',
    'Example: Submit a question like "What caused the decline in bee populations?" and the AI prompt will classify it as factual/analytical, separate known facts from speculation, generate competing explanations, check for contradictions, and present findings with clear confidence levels and uncertainties rather than definitive claims.',
  ],
};

export default reduceAIHallucinationsPrompt;
