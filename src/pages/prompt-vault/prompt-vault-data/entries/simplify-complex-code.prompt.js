const simplifyComplexCodePrompt = {
  emoji: '📜',
  title: 'Simplify Complex Code',
  description: 'Simplify complex code with this AI prompt, transforming verbose scripts into elegant, human-readable code while maintaining functionality.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
export default simplifyComplexCodePrompt;
