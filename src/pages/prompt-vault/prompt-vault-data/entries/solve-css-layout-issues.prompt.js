const solveCSSLayoutIssuesPrompt = {
  emoji: '🔍',
  title: 'Solve CSS Layout Issues',
  description: 'Request detailed CSS debugging assistance with this AI prompt, tailored for resolving complex layout issues across browsers.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
- Prevention tips as bullet points`,
  ...
  howToUse: [
    'Fill in the [DESCRIBE YOUR SPECIFIC LAYOUT ISSUE], [PASTE YOUR CODE HERE], and [LIST BROWSERS YOU NEED TO SUPPORT] placeholders inside #INFORMATION ABOUT ME section with your specific layout problem, HTML/CSS code, and target browsers.',
    'Example: "My layout problem is that the sidebar overlaps the main content on mobile. My HTML/CSS code includes a flexbox layout with a sidebar and main content section. I need to support Chrome, Firefox, and Safari."',
  ],
};

export default solveCSSLayoutIssuesPrompt;
