const technicalExpertBlockchainTechnologyTaskedPrompt = {
  emoji: '⛓️',
  title: 'Technical Expert Blockchain Technology Tasked',
  description: 'How can I design and implement a secure and transparent blockchain-based voting system prototype?',
  type: 'Prompts',
  category: 'Technology',
  tool: 'ChatGPT',
  output: 'Text',
...
export default technicalExpertBlockchainTechnologyTaskedPrompt;
