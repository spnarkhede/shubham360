const transformFaqsIntoKnowledgeBasesPrompt = {
  emoji: '🏛️',
...
Output each complete article separated by --- and formatted consistently for direct knowledge base import.`,
  ...
  howToUse: [
    'Paste full FAQ set and include product + customer skill level.',
    'Run prompt and publish resulting articles as a connected KB set.',
  ],
};

export default transformFaqsIntoKnowledgeBasesPrompt;
