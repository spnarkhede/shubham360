const writeImageResizingScriptPrompt = {
  emoji: '🖼️',
  title: 'Write Image Resizing Script',
  description: 'Create a comprehensive image resizing script with this AI prompt, ensuring quality and efficiency for diverse client projects.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Image',
...
Structure the response with clear headings for each component and provide both basic usage examples and advanced customization options.`,
  ...
  howToUse: [
    'Inside #INFORMATION ABOUT ME section, fill in the [INSERT SOURCE FOLDER PATH OR FILE PATHS], [INSERT DIMENSIONS (e.g., 1920x1080) OR PERCENTAGE (e.g., 50%)], [INSERT FORMAT OR "same as source"], [INSERT "maximum quality", "balanced", or "minimum file size"], and [INSERT DESTINATION PATH] placeholders with your specific image processing details.',
    'Example: "My source image location(s): /images/source, My target dimensions or scaling: 1920x1080, My preferred output format: JPEG, My quality preference: balanced, My output folder location: /images/output."',
  ],
};

export default writeImageResizingScriptPrompt;
