const writeIntegrationTestsPrompt = {
  emoji: '🛠️',
  title: 'Write Integration Tests',
  description: 'Guide developers in creating bulletproof integration tests with this AI prompt, focusing on verifying component interactions and API contracts using the Testing Pyramid principle.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
Type "continue" to complete your test framework.`,
  ...
  howToUse: [
    ...
    'Example: "Components needing integration testing: User Service → Payment API → Database. Critical API contracts: Payment processing and user authentication. Test framework: Jest. Problematic integration: User registration and payment processing."',
  ],
};

export default writeIntegrationTestsPrompt;
