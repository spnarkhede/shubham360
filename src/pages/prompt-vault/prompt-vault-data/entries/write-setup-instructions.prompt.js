const writeSetupInstructionsPrompt = {
  emoji: '🛠️',
  title: 'Write Setup Instructions',
  description: 'Create foolproof setup instructions with this AI prompt, ensuring users succeed on their first attempt without needing additional help.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your response with numbered steps, include exact commands in code blocks for copy-pasting, provide "What you should see" confirmation points after critical steps, and create a troubleshooting section that addresses problems before users encounter them. Use clear headings and bullet points for maximum readability.`,
  ...
  howToUse: [
    'Fill in the [INSERT SOFTWARE OR APPLICATION NAME], [INSERT OPERATING SYSTEMS - Windows, Mac, Linux, etc.], [INSERT SKILL LEVEL - Beginner, Intermediate, Advanced], [INSERT ANY REQUIRED SOFTWARE, ACCOUNTS, OR SYSTEM REQUIREMENTS], and [INSERT ANY KNOWN INSTALLATION PROBLEMS OR ERROR MESSAGES] placeholders with specific details about the software, target operating systems, user skill level, prerequisites, and known issues.',
    'Example: "My software/application to install: PhotoEditor Pro. My target operating systems: Windows and Mac. My user\'s technical skill level: Beginner. My known prerequisites needed: .NET Framework for Windows, Xcode for Mac. My common setup issues I\'m aware of: Error 404 during download, permission issues on Mac."',
  ],
};

export default writeSetupInstructionsPrompt;
