const writeVersionChangelogPrompt = {
  emoji: '📜',
  title: 'Write Version Changelog',
  description: 'Create detailed changelog documentation with this AI prompt, organizing software updates into clear, user-friendly categories.',
  type: 'Prompts',
  category: 'Coding',
  tool: 'ChatGPT',
  output: 'Code',
...
MOST IMPORTANT!: Structure your output in proper Keep a Changelog markdown format with clear section headers, bullet points for each change, and maintain chronological ordering with the newest version at the top.`,
  ...
  howToUse: [
    'Fill in the [INSERT VERSION NUMBER], [INSERT ALL CHANGES AND NEW FEATURES ADDED], [INSERT ALL BUG FIXES AND ISSUES RESOLVED], [INSERT ANY BREAKING CHANGES OR DEPRECATIONS], and [INSERT ANY SECURITY-RELATED CHANGES] placeholders with specific details about the software release.',
    'Example: "Version 2.1.0: Added new user authentication features, resolved login bug, deprecated old API endpoints, and implemented security patches for data encryption vulnerabilities."',
  ],
};

export default writeVersionChangelogPrompt;
